...
k8s_assert_equal "$EXOSCALE_MASTER_NAME" "failure-domain\.beta\.kubernetes\.io/region" "ch-gva-2"
...
k8s_assert_equal "$EXOSCALE_MASTER_NAME" "topology\.kubernetes\.io/region" "ch-gva-2"

k8s_assert_equal "$EXOSCALE_NODE_NAME" "failure-domain\.beta\.kubernetes\.io/region" "ch-gva-2"
...
k8s_assert_equal "$EXOSCALE_NODE_NAME" "topology\.kubernetes\.io/region" "ch-gva-2"
