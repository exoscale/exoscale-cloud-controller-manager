...
# Cluster
output "cluster_id" {
  value = exoscale_sks_cluster.cluster.id
}
...
output "control_plane_endpoint" {
  value = "https://${exoscale_sks_cluster.cluster.id}.${var.exoscale_environment == "preprod" ? "ppsks" : "sks"}-${var.exoscale_zone}.exo.io:6443"
}
